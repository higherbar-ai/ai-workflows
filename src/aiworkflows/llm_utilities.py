...
class LLMInterface:
    ...
    def __init__(self, openai_api_key: str = None, openai_model: str = None, temperature: float = 0.0,
                 ...
                 langsmith_project: str = 'aiworkflows', langsmith_endpoint: str = 'https://api.smith.langchain.com'):
        """
        ...
        :param langsmith_project: LangSmith project name. Default is 'aiworkflows'.
